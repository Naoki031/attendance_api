...
4. If **approved**: status changes to Approved; if Google Sheets is configured for that request type, a row is written automatically; approval count badge updates instantly
